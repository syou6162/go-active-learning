...
func TestSortByScore(t *testing.T) {
	...
	e1.Title = "bookmark"; e1.Fv = []string{"hoge", "fuga"}
	e2 := NewExample("http://google.com", NEGATIVE)
	e2.Title = "google"; e2.Fv = []string{"piyo", "aaa"}
	e3 := NewExample("http://hatena.ne.jp", UNLABELED)
	e3.Title = "hatena"; e3.Fv = []string{"hoge", "fuga"}
	e4 := NewExample("http://hogehoge.com", UNLABELED)
	e4.Title = "hogehoge"; e4.Fv = []string{"piyo", "hoge"}
