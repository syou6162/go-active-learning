...
func (r *repository) UpdateRelatedExamples(related model.RelatedExamples) error {
	...
	if _, err := r.db.Exec(`INSERT INTO related_example (example_id, related_example_id) VALUES ($1, unnest(cast($2 AS INT[])));`, related.ExampleId, related.RelatedExampleIds); err != nil {
		return err
	}
	return nil
}
